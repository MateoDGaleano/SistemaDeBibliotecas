...
class Usuario:
    ...
    Además, hay algunos atributos ocultos para el manejo de perfiles de usuario.
    ...
    multa_vigente: que contiene la multa actual que deba el usuario.
    ...
    #ESTE MÉTODO PERMITE CAMBIAR EL TIPO DE PERFIL DEL USUARIO
